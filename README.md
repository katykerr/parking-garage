...
- payForParking
   - Display an input that waits for an amIf the payment variable is not empty then (meaning the ticket has been paid) ->  display a message to the user that their ticket has been paid and they have 15mins to leaveount from the user and store it in a variable
   - 
